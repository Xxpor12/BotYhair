...
smsAutodetec6: (m) => `𝗘𝘀𝘁𝗲 𝗚𝗿𝘂𝗽𝗼 𝗛𝗮 𝗦𝗶𝗱𝗼 ${m.messageStubParameters[0] == 'on' ? ' 𝗖𝗲𝗿𝗿𝗮𝗱𝗼' : '𝗔𝗯𝗶𝗲𝗿𝘁𝗼'}\n ${m.messageStubParameters[0] == 'on' ? '𝗦𝗼𝗹𝗼 𝗣𝘂𝗲𝗱𝗲𝗻 𝗛𝗮𝗯𝗹𝗮𝗿 𝗟𝗼𝘀 𝗔𝗱𝗺𝗶𝗻𝘀' : '𝗬𝗮 𝗣𝘂𝗲𝗱𝗲𝗻 𝗛𝗮𝗯𝗹𝗮𝗿 𝗧𝗼𝗱𝗼𝘀'} 𝗬𝗮 𝗣𝘂𝗲𝗱𝗲𝗻 𝗛𝗮𝗯𝗹𝗮𝗿 𝗧𝗼𝗱𝗼𝘀`, 
smsAutodetec7: (m, usuario) =>  `𝗔𝗵𝗼𝗿𝗮 @${m.messageStubParameters[0].split`@`[0]} 𝗘𝘀𝘁𝗲 𝗨𝘀𝘂𝗮𝗿𝗶𝗼 𝗘𝘀 𝗔𝗱𝗺𝗶𝗻 𝗗𝗲𝗹 𝗚𝗿𝘂𝗽𝗼\n\n𝗚𝗿𝗮𝗰𝗶𝗮𝘀 𝗔: ${usuario}`, 
smsAutodetec8: (m,  usuario) => `𝗔𝗵𝗼𝗿𝗮 @${m.messageStubParameters[0].split`@`[0]} 𝗘𝘀𝘁𝗲 𝗨𝘀𝘂𝗮𝗿𝗶𝗼 𝗬𝗮 𝗡𝗼 𝗘𝘀 𝗔𝗱𝗺𝗶𝗻\n\n𝗚𝗿𝗮𝗰𝗶𝗮𝘀 𝗔: ${usuario}`, 
...
//grupos
smsAdd: 'Hola! me presento, soy Time Long-MD 🐈, soy un Bot de WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te unas al grupo, te esperamos con ansias!!', 
