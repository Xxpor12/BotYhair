...
//_allantilink.js
const smsTextoYT = () => { return '𝗧𝗲𝗮𝗺 𝗛𝘆𝗱𝗿𝗮 𝗕𝗼𝘁'} 
...
//_antiviewonce.js
const smsAntiView = () => { return `*TODO LO VE TEAM HYDRA BOT* 😎`} 
...
const smsGrupoTime7 = () => { return '*F EL GRUPO YA HA CERRADO , PRESTEN ATENCION A LOS JEFES*'}
const smsGrupoTime8 = () => { return '*WEE EL GRUPO YA HABRIO , HABLEN TODOS COÑOO*'}
