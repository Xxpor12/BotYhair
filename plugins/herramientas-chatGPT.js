...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
        ...
        let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Team Hydra, tu seras Team Hydra Bot.`;
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Team Hydra, tu seras Team Hydra Bot.`;
